...
from cortex.llm_clients import create_llm_client
...
from cortex.dataflows.utils import safe_ticker_component
from cortex.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
from cortex.dataflows.config import set_config

# Import the new abstract tool methods from agent_utils
from cortex.agents.utils.agent_utils import (
    get_stock_data,
    get_indicators,
    get_fundamentals,
    get_balance_sheet,
...
class CortexGraph:
    ...
    def _run_graph(self, company_name, trade_date):
        ...
        return final_state, self.process_signal(final_trade_decision) if final_trade_decision else None
    ...
    def _log_state(self, trade_date, final_state):
        ...
        self.log_states_dict[str(trade_date)] = {
            ...
            "investment_debate_state": {
                ...
                "current_response": final_state.get("investment_debate_state", {}).get(
                    "current_response", ""
                ),
        ...
        directory = Path(self.config["results_dir"]) / safe_ticker / "CortexStrategy_logs"
