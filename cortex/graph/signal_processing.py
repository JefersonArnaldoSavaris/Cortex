...
header (see :func:`cortex.agents.schemas.render_pm_decision`).  The
deterministic heuristic in :mod:`cortex.agents.utils.rating` is more
...
from cortex.agents.utils.rating import parse_rating
