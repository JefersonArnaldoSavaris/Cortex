...
class AnalysisService:
    ...
    def __init__(self, reports_dir: Path | None = None):
        ...
        self._executor = ThreadPoolExecutor(max_workers=int(os.getenv("TRADINGAGENTS_API_WORKERS", "1")))
        self.reports_dir = reports_dir or Path(os.getenv("TRADINGAGENTS_REPORTS_DIR", "reports"))
    ...
    def _run_analysis(self, analysis_id: str) -> None:
        ...
        try:
            ...
            self._append_event(analysis_id, "Building TradingAgents graph")
