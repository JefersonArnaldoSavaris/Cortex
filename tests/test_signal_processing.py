...
header.  The deterministic heuristic in ``cortex.agents.utils.rating``
...
from cortex.agents.utils.rating import RATINGS_5_TIER, parse_rating
from cortex.graph.signal_processing import SignalProcessor
