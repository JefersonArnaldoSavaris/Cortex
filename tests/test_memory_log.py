...
from cortex.agents.utils.memory import TradingMemoryLog
from cortex.agents.schemas import PortfolioDecision, PortfolioRating
from cortex.graph.reflection import Reflector
from cortex.graph.trading_graph import CortexGraph
from cortex.graph.propagation import Propagator
from cortex.agents.managers.portfolio_manager import create_portfolio_manager
...
class TestDeferredReflection:
    ...
    def test_fetch_returns_valid_ticker(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            raw, alpha, days = CortexGraph._fetch_returns(mock_graph, "NVDA", "2026-01-05")
    ...
    def test_fetch_returns_too_recent(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            raw, alpha, days = CortexGraph._fetch_returns(mock_graph, "NVDA", "2026-04-19")
    ...
    def test_fetch_returns_delisted(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            mock_ticker_cls.return_value = m
            raw, alpha, days = CortexGraph._fetch_returns(mock_graph, "XXXXXFAKE", "2026-01-10")
        assert raw is None and alpha is None and days is None
    ...
    # CortexGraph._resolve_pending_entries
    ...
    def test_resolve_skips_other_tickers(self, tmp_path):
        ...
        CortexGraph._resolve_pending_entries(mock_graph, "NVDA")
...
class TestPortfolioManagerInjection:
    ...
    def test_pm_returns_rendered_markdown_with_rating(self):
        ...
        assert "**Classificação**: Sobreponderar" in md
        assert "**Resumo Executivo**: Build position gradually" in md
        assert "**Tese de Investimento**: AI capex cycle" in md
        assert "**Preço-Alvo**: 215.0" in md
        assert "**Horizonte de Tempo**: 3-6 months" in md
...
class TestLegacyRemoval:
    ...
    def test_financial_situation_memory_removed(self):
        ...
        import cortex.agents.utils.memory as m
    ...
    def test_reflect_and_remember_removed(self):
        """CortexGraph must not expose reflect_and_remember."""
        assert not hasattr(CortexGraph, "reflect_and_remember")
    ...
    def test_full_pipeline_no_regression(self, tmp_path):
        ...
        mock_graph._run_graph = functools.partial(
            CortexGraph._run_graph, mock_graph
        )
        CortexGraph.propagate(mock_graph, "NVDA", "2026-01-10")
